...
static hid_device *new_hid_device()
{
	...
	dev->ol.hEvent = CreateEvent(NULL, TRUE/*FALSE*/, FALSE /*inital state f=nonsignaled*/, NULL);
...
//		res = ReadFile(dev->device_handle, dev->read_buf, dev->input_report_length, &bytes_read, &dev->ol);
		res = ReadFile(dev->device_handle, dev->read_buf, dev->input_report_length, &bytes_read, &ov);
	...
	res = GetOverlappedResult(dev->device_handle, &ov, &bytes_read, FALSE/*wait*/);
